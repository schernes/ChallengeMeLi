...
# FUNCIONES PARA ACCIONES SOBRE LA BASE DE DATOS
...
def borrarArchivos(x):
    ...
    miCursor.execute("DELETE FROM TABLA_PUENTE")


if __name__ == "__main__":
    buscaPub("mimeType != 'application/vnd.google-apps.folder' and trashed = false and 'me' in owners and title = 'PruebaJS.txt' and visibility != 'limited'")
    recorreDrive("mimeType != 'application/vnd.google-apps.folder' and trashed = false and 'me' in owners and title = 'PruebaJS.txt'")
